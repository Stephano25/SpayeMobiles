...
export default function AdminWithdrawScreen() {
  ...
  const handleSubmit = async () => {
    ...
    Alert.alert(
      ...
      `Retirer ${formatAmount(amountNum)} Ar du compte de ${user?.firstName} ${user?.lastName} ?`,
      [
              ...
              <View style={styles.userList}>
                {users.map(user => (
                  ...
                  >
                    ...
                    <Text style={[styles.userBalance, { color: (user.balance || 0) >= 100 ? COLORS.success : COLORS.error }]}>
            ...
            {getSelectedUser() && (
              <View style={[styles.card, { backgroundColor: colors.card }]}>
                ...
                <TextInput
                  ...
                  placeholder="Ex: Retrait, paiement..."
                  placeholderTextColor={COLORS.gray400}
                />
                ...
                <TouchableOpacity
                  ...
                  disabled={submitting || !amount || parseFloat(amount) < 100 || (getSelectedUser()?.balance || 0) < parseFloat(amount || '0')}
                >
                  {submitting ? (
                    ...
                    <>
                      ...
                      <Text style={styles.submitText}>Retirer</Text>
                    </>
                  )}
                </TouchableOpacity>
              </View>
